 ...
 */
package com.wincomplm.wex.example.commons.ext.impl.bootstrap;

import com.wincomplm.wex.example.commons.WexExampleHelper;
...
public class WexBootstrap implements IWexBootstrap {
    ...
    public void initialize(IWexKernelPackage wex) throws Exception {
        WexScanner.scan(wex, "com.wincomplm.wex.example.commons.ext");
        System.out.println("Version of commons " + WexExampleHelper.instance.getVersion());
    }
